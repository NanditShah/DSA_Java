...
public class MaximumNumberOfRemovableCharacters {
    public static void main(String[] args) {
        System.out.println("Maximum Number of Removable Characters");
    ...
    static String remove(final String s, int[] removable, int k) {
    ...
    static boolean isSubsequence(final String p, final String s) {
        int i = 0; // p's index
